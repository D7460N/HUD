										...
										<div class="card-body">
											<div class="row">
												<div class="col-xl-6 mb-xl-0 mb-3">
													...
													<div class="mb-2 small text-inverse text-opacity-50"><b class="fw-bold">NAV UNDERLINE</b></div>
													<nav class="nav nav-underline mb-3 ps-3">
														<a class="nav-link active me-3" href="#">Active</a>
														<a class="nav-link me-3" href="#">Link</a>
														<a class="nav-link me-3" href="#">Link</a>
														<a class="nav-link me-3 disabled" href="#">Disabled</a>
													</nav>
												</div>
												<div class="col-xl-6">
