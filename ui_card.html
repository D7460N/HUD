												...
												<div class="card-body">
													<div class="card">
														<div class="card-header fw-bold small d-flex">
															...
															<a href="#" data-toggle="card-expand" class="text-inverse text-opacity-50 text-decoration-none"><i class="fa fa-fw fa-expand"></i> EXPAND</a>
														</div>
														<div class="card-body">
															<h5 class="card-title">Card title</h5>
															<h6 class="card-subtitle mb-3 text-inverse text-opacity-50">Card subtitle</h6>
								...
								<div id="navigation" class="mb-5">
									...
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-3"><b class="fw-bold">NAV TABS</b></div>
													<div class="card mb-3">
												...
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-3"><b class="fw-bold">NAV PILLS</b></div>
													<div class="card mb-3">
														<div class="card-header">
								...
								<div id="images" class="mb-5">
									...
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-3"><b class="fw-bold">IMAGE CAPS</b></div>
													<div class="card mb-3">
												...
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-3"><b class="fw-bold">IMAGE OVERLAY</b></div>
								...
								<div id="cardStyles" class="mb-5">
									...
									<div class="card">
										<div class="card-body">
											<div class="row">
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-3"><b class="fw-bold">BACKGROUND AND BORDER</b></div>
													<div class="card border-theme bg-theme bg-opacity-25 mb-3">
														<div class="card-header border-theme fw-bold small text-inverse">HEADER</div>
														<div class="card-body">
												...
												<div class="col-xl-6">
													<div class="small text-inverse text-opacity-50 mb-3"><b class="fw-bold">BORDER AND COLOR</b></div>
							...
							<div class="col-xl-3">
								...
								<nav id="sidebar-bootstrap" class="navbar navbar-sticky d-none d-xl-block">
									<nav class="nav">
										...
										<a class="nav-link" href="#gridCards" data-toggle="scroll-to">Grid cards</a>
