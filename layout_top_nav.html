...
<body class='pace-top'>
	...
	<div id="app" class="app app-with-top-nav app-without-sidebar">
		...
		<div id="content" class="app-content">
			...
			<p>
				Add the <code>.app-with-top-nav</code>, <code>.app-without-sidebar</code> css class to <code>.app</code> container for top nav page setting. 
				You might need to add the mobile toggler for top nav as well.
			</p>
			
			<div class="card">
				<div class="hljs-container border-0">
					<pre><code class="xml" data-url="assets/data/layout-top-nav/code-1.json"></code></pre>
				</div>
