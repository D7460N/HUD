...
<body class='pace-top'>
	...
	<div id="app" class="app app-with-top-nav app-boxed-layout">
		...
		<div id="content" class="app-content">
			...
			<p>
				Add the <code>.app-with-top-nav</code> and <code>.app-boxed-layout</code> css class to <code>.app</code> container for mixed nav with boxed layout page setting. 
				Please reminded that if you wish to have both mobile toggler for sidebar and top nav, you might need to adjust 
				the mobile toggler in order to fit into the mobile design.
			</p>
			
			<div class="card">
				<div class="hljs-container border-0">
					<pre><code class="xml" data-url="assets/data/layout-mixed-nav-boxed-layout/code-1.json"></code></pre>
				</div>
